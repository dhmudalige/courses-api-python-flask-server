...
class TestGetMethodsController(BaseTestCase):
    ...
    def test_get_course_by_code(self):
        ...
        response = self.client.open(
            '/peraprojects/courses/2.1.0/{semester}/{courseCode}/'.format(semester='semester_example', courseCode='courseCode_example'),
            method='GET')
    ...
    def test_get_course_details_by_semester(self):
        ...
        """
        response = self.client.open(
            '/peraprojects/courses/2.1.0/{semester}/'.format(semester='semester_example'),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
